...
for i=1:length(all_images)
    ...
    albedo_image_filename = fullfile(path, ['iteration_', num2str(iteration_index)], 'SFS', sprintf('albedo_transferred_%d.png', image_index));
    deformation_image_filename = fullfile(path, ['iteration_', num2str(iteration_index)], 'SFS', sprintf('deformation_%d.png', image_index));
    ...
    deformation_mask_filename = fullfile(path, ['iteration_', num2str(iteration_index)], 'SFS', sprintf('deformation_mask_%d.png', image_index));
